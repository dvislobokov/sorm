// Package models — the todo application schema.
// The evolution history lives in ../migrations: init → add_tasks → add_priority;
// each file was generated by `sorm migrate diff` (see README).
package models
